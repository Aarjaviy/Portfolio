        ...
        <div id="about" className="container py-5">
            <div className="row">
                ...
                <h1 className="about-heading">About Me</h1>
                    <p>
                        I am Aarjaviy, Pre-final year student at IIT Roorkee. This portfolio express my interest in joining your company as an Intern. I am open to roles in the domain of Frontend and Backend Development. I think a growing company like yours will give me a great opportunity to learn from a variety of people and also help me understand the key intricacies of Development.
